...
export const WORMHOLE_RECEIVER_BASE_SEPOLIA: Address = '0xe3F3Fb3a7a5B046298817f0AB073a659f68cbdB3'
export const WORMHOLE_RECEIVER_ARBITRUM_SEPOLIA: Address = '0x847a6c5a32F5Ed69c43a82f46a84Df75f9B9Bd2A'
...
export const RECEIVER_CONTRACT_ADDRESSES: ReceiverContracts = {
  10003: '0x847a6c5a32F5Ed69c43a82f46a84Df75f9B9Bd2A' as Address, // Arbitrum Sepolia
